...
{
    public class baseClass : electoEntities
    {
    ...
    public static class BaseUtil
    {
        ...
        public static int CaptureErrorValues(Exception exception)
        {
            ...
            try
            {
                ...
                if (HttpContext.Current.Session != null)
                {
                    userID = HttpContext.Current.Session[AdminInfo.LoginID.ToString()] != null ? Convert.ToInt32(HttpContext.Current.Session[AdminInfo.LoginID.ToString()].ToString()) : 0;
                }
        ...
        {           
            ...
            try
            {
                var au = db.userRights.Where(e=>e.userTypeID== UserRole).Select(e=> new
                          {
                              ACTION = (e.controller_name+e.action_name ).ToUpper()
                          }
                          ).ToList();
